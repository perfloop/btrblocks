...
func encodeBitpack[T Integer](arr array.ArrayCore[T]) (EncodedArray[T], error) {
...
func buildBitPackedArrayWithWidth[T Integer](arr array.ArrayCore[T], bitWidth uint) (*bitPackedArray[T, uint64], error) {
	return buildBitPackedArrayCore(arr, bitWidth)
}

func buildBitPackedArrayCore[T Integer](arr array.ArrayCore[T], bitWidth uint) (*bitPackedArray[T, uint64], error) {
	n := arr.Length()
