...
func estimateConst[T array.Integer | array.Float | array.String](arr array.ArrayCore[T], ctx planContext, isConst bool) schemeEstimate {
...
func estimateKnownSequence[T array.Integer](arr array.ArrayCore[T], isSequence bool, base, step T) schemeEstimate {
	if !isSequence {
		return skipEstimate()
	}
...
func estimateDelta[T array.Integer](stats intStats[T], ctx planContext, family integerFamily) schemeEstimate {
	...
	upperRatio := deltaRatioForWidth[T](stats.Source(), 1, 0, family)
...
func estimateRunEnd[T array.Integer | array.Float | array.String, S statsSource[T]](stats S, ctx planContext, avgRunLength float64, sampleEligible bool) schemeEstimate {
